...
fs.API.expose("optOut", function() {
  ...
  _W.location = wloc.indexOf("#")
    ? wloc.substr(0, wloc.indexOf("#") - 1) + "#fscommand=fsoptout"
    : wloc + "#fscommand=fsoptout";
  _W.location.reload();
});
...
fs.API.expose("test", function() {
  var wloc = _W.location.toString();
  _W.location = wloc.indexOf("#")
    ? wloc.substr(0, wloc.indexOf("#") - 1) + "#fscommand=fstest"
    : wloc + "#fscommand=fstest";
  _W.location.reload();
});
  ...
  __apiReady.subscribe(
    function() {
      ...
      console.warn(
        ...
        !!displayoverride ? displayoverride : "no display override specified"
      );
      /* pragma:DEBUG_END */
      ...
      var trig =
        Singletons.trig ||
        TriggerSetup(Singletons.stg, config, Singletons.browser, Singletons.crit, Singletons.CPPS);
