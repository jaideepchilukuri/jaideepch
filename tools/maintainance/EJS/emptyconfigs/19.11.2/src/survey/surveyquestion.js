...
class SurveyQuestion {
   ...
   * @param el DOMElement - DOM markup for the question
  ...
  initQuestion(el, cfg) {
    ...
    this.cfg.isPersistent = !!$(this.el).hasClass("acs-persistent__block");
  ...
  hide() {
    ...
    if (!this.cfg.isPersistent) {
      $(this.el).addClass("acs-feedback__block--hidden");
    }
  }
  ...
  show() {
    ...
    if (!this.cfg.isPersistent) {
      $(this.el).removeClass("acs-feedback__block--hidden");
    }
  }
  ...
  validate() {
    ...
    if (this.cfg.isVisible) {
      ...
      if (!rtn) {
        $(this.el).addClass("acs-feedback__block--invalid");
      } else {
        $(this.el).removeClass("acs-feedback__block--invalid");
      }
    }
    return rtn;
  }
