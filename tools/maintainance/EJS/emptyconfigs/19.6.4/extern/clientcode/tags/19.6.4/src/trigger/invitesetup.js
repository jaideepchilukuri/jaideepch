...
(function () {
  ...
  var getInviteSetupInstance = function (trig, browser, stg, cpps, displayoverride, jrny, readycallback) {
    if (!Singletons.inviteSetup) {
      Singletons.inviteSetup = new InviteSetup(trig, browser, stg, cpps, displayoverride, jrny, readycallback);
    } else {
