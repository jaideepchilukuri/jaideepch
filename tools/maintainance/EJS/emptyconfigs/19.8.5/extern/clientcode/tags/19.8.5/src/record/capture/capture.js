...
var Capture = function(
  ...
  var hidden, visibilityChange, tevents, i, mouseMoveTarget;
  ...
  if (isTop) {
    ...
    this.rec.bind(
      window,
      pageHiddenKeys.visibilityChange,
      function(e) {
...
Capture.prototype.bindToFrame = function(frm, winRef) {
  ...
  winRef.__fsrec__ = frmrec = new Recorder(
    this.rec.stg,
    this.rec.browser,
    winRef,
