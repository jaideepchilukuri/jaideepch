...
(function () {
  ...
  Admin.prototype._applyValues = function () {
    ...
    this.stg.set('ovr', JSON.stringify(overrideobject), null, true, function () {
  ...
  Admin.prototype.render = function () {
    ...
    if (setb) {
      utils.Bind(setb, "click", function (e) {
    ...
    if (clearb) {
      utils.Bind(clearb, "click", function (e) {
        utils.preventDefault(e);
        this.stg.reset(function () {
    ...
    if (retbtw) {
      utils.Bind(retbtw, "click", function (e) {
        utils.preventDefault(e);
