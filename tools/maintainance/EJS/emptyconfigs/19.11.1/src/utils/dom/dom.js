 ...
 * @returns {boolean}
 */
const toggleClass = (el, cname, force) => {
  if ((hasClass(el, cname) && force !== false) || force === true) {
    addClass(el, cname);
    return true;
  } else {
...
export { addClass, removeClass, hasClass, toggleClass, decodeHTMLEntities, DOMContains };
