    ...
    browser.ready.subscribe(function () {
      ...
      stg.ready.subscribe(fs.proxy(function () {
        ...
        stg.upgradeOldStorage(function () {
          ...
          var customerId = fs.config.customerId || config.config.id || utils.getRootDomain();

          // Set up the journey class
          var jrny = Singletons._journey = new utils.Journey(customerId, utils.APPID.TRIGGER, stg.uid, browser, 100);
