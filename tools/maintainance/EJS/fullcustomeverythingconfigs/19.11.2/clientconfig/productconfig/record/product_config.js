...
module.exports = {
  ...
  blacklist: {
    ...
    variables: [{ name: "custom_blacklistvariablename", value: "custom_blacklistvariablevalue" }],
    cookies: [{ name: "custom_blacklistcookiename", value: "custom_blacklistcookievalue" }],
    cpps: [{ name: "custom_blacklistcppname", value: "custom_blacklistcppvalue" }],
  },
  ...
  whitelist: {
    ...
    variables: [{ name: "custom_whitelistvariablename", value: "custom_whitelistvariablevalue" }],
    cookies: [{ name: "custom_whitelistcookiename", value: "custom_whitelistcookievalue" }],
    cpps: [{ name: "custom_whitelistcppname", value: "custom_whitelistcppvalue" }],
  },
