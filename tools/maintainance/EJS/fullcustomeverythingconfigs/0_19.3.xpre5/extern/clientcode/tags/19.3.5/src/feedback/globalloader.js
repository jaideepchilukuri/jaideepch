...
(function () {
   ...
   * 1. Check Health.
   * 2. Prefetch all the templates by calling TemplateGrabber Function.
   * 3. Keep track of all the templates and do NOT fire unnecessary requests.
   */
  var GlobalLoader = function (browser, cpps, templateTypes) {
    ...
    // Do a Health Check..
    asyncQ.enqueue(fs.proxy(function (prom) {
