...
// async function testTemplateGlobalConfigLocal(sitekey, codeVersionToTest, filename) {
// 	let expected = await getAConfig(codeVersionToTest, `/EJS/${sitekey}/${codeVersionToTest}/clientconfig/`, filename);
// 	//file specific logic to make emptyconfigs match (this wouldn't be necessary if emptyconfigs were built exact same to deploy as they are recreated from the template)
// 	if (sitekey == "emptyconfigs" && expected && expected.module && expected.module.exports) {
// 		if (
// 			expected.module.exports.transporturl == "https://rec.replay.answerscloud.com/rec/" ||
// 			expected.module.exports.transporturl == "https://dev-record.foresee.com/rec/"
// 		) {
...
// 		}
// 		if (expected.module.exports.surveyasynccurl == "i.4see.mobi") {
// 			expected.module.exports.surveyasynccurl = "" /*FIX THIS BY PUSHING OUT A NEW GLOBAL CONFIG! "s.foresee.com"*/;
// 		}
// 	}
// 	let created = await getAConfig(codeVersionToTest, `/../clientconfigs/${sitekey}/CC/clientconfig/`, filename);
// 	let matching = await testMatchingHelperFunction(expected, created, `${sitekey} ${filename}`);
// 	return matching;
// }

// async function testTemplateClientProperties(sitekey, codeVersionToTest, filename) {
// 	let expected = await getAConfig(codeVersionToTest, `/EJS/${sitekey}/${codeVersionToTest}/clientconfig/`, filename);
// 	//file specific logic to make emptyconfigs match (this wouldn't be necessary if emptyconfigs were built exact same to deploy as they are recreated from the template)
// 	if (
// 		sitekey == "emptyconfigs" &&
...
// 		expected.module &&
// 		expected.module.exports &&
// 		expected.module.exports.client
// 	) {
// 		if (expected.module.exports.client.id == null) {
// 			expected.module.exports.client.id = "";
// 		}
...
// async function testTemplateRecordProductConfig(sitekey, codeVersionToTest, filename) {
// 	let expected = await getAConfig(codeVersionToTest, `/EJS/${sitekey}/${codeVersionToTest}/clientconfig/`, filename);
// 	//file specific logic to make emptyconfigs match (this wouldn't be necessary if emptyconfigs were built exact same to deploy as they are recreated from the template)
// 	if (sitekey == "emptyconfigs" && expected && expected.module && expected.module.exports) {
// 		if (JSON.stringify(expected.module.exports.whitelist) == `{"text":[],"variables":[],"cookies":[]}`) {
...
// async function testTemplateTriggerProductConfig(sitekey, codeVersionToTest, filename) {
// 	let expected = await getAConfig(codeVersionToTest, `/EJS/${sitekey}/${codeVersionToTest}/clientconfig/`, filename);
// 	//this line needs to be revisited to be more specific to code version, or better yet we need to add logic to handle this correctly for all code versions (we never really prepared for downgrading before)
// 	if (expected && expected.module && expected.module.exports && expected.module.exports.cpps) {
// 		for (cpp in expected.module.exports.cpps) {
// 			if (expected.module.exports.cpps[cpp] && expected.module.exports.cpps[cpp].source == "cookie") {
// 				if (expected.module.exports.cpps[cpp].name) {
// 					expected.module.exports.cpps[cpp].val = expected.module.exports.cpps[cpp].name;
...
// async function testTemplateSurveyDefs(sitekey, codeVersionToTest, filename) {
// 	let expected = await getAConfig(
// 		codeVersionToTest,
// 		`/EJS/${sitekey}/${codeVersionToTest}/clientconfig/`,
// 		filename,
...
// 	);
// 	if (expected && expected.module && expected.module.exports) {
// 		if (expected.module.exports.display && expected.module.exports.display.desktop_legacy_disabled) {
// 			delete expected.module.exports.display.desktop_legacy_disabled;
// 		}
// 		//file specific logic to make emptyconfigs match (this wouldn't be necessary if emptyconfigs were built exact same to deploy as they are recreated from the template)
// 		if (sitekey == "emptyconfigs") {
...
// 		}
// 	}
// 	let created = await getAConfig(codeVersionToTest, `/../clientconfigs/${sitekey}/CC/clientconfig/`, filename, "000");
// 	//all the following rules really need to be revisited and hopefully handled in a better way, none of them are great in real life scenarios but they make the tests work - shouldn't be common real life scenarios
// 	if (created && created.module && created.module.exports) {
// 		if (created.module.exports.display) {
// 			if (created.module.exports.display.desktop_legacy_disabled) {
// 				if (fcpvals.legacyDesktopVersions.includes(codeVersionToTest)) {
// 					created.module.exports.display.desktop = created.module.exports.display.desktop_legacy_disabled;
...
module.exports = {
	...
	cleanUpTemplateTest,
	testTemplate,
	// testTemplateGlobalConfigLocal,
	// testTemplateClientProperties,
	// testTemplateRecordProductConfig,
	// testTemplateTriggerProductConfig,
	// testTemplateSurveyDefs,
};
