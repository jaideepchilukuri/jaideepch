...
module.exports = {
   ...
   */
  inviteExclude: {
	urls : ["*basket*", "*cart*", "*checkout*", "*login*", "*register*", "*registration*", "*signin*", "*signup*", "*apply*", // common default url patterns to not pop invites on
    ],
    referrers: [],
    userAgents: [],
    browsers: [],
    cookies: [],
    variables: [{ name : "foresee_noinvite", value : "true"}, // common default variable to check to suppress the invite
    ],
  },
