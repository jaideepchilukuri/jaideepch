...
(function (utils) {
  ...
  var _fsStorage = function (browser, uidoverride) {
    ...
    browser.ready.subscribe(function () {
      ...
      this._sync(function () {
        ...
        // Signal ready
        /*if (this.fr) {
          this.fr.ready.subscribe(function () {
  ...
  _fsStorage.prototype.selectCookieDomain = function (cookieDomain, path) {
    ...
    if (!fs.isDefined(cookieDomain) || !fs.isArray(cookieDomain) || cookieDomain.length < 1) {
  ...
  _fsStorage.prototype.save = function (emergency) {
    if (emergency) {
      ...
      if (!this._svT && this.isStale) {
        this._svT = setTimeout(this._commit.bind(this), Math.max(0, this._cThreshold - (nw - this._lastSave)));
      }
    }
  };
  ...
  _fsStorage.prototype.set = function (key, value, expiration, emergency, datatype, callback) {
    this._readyState.subscribe(function () {
      ...
      if ((this.pers == utils.storageTypes.CK || this.pers == utils.storageTypes.DS) && datatype == utils.persistDataType.TRACKER) {
        if (!this.fr) {
          this.fr = new utils.Frame(this.browser);
        }
        this.fr.trackerReady.subscribe(function () {
