...
(function (trigger) {
  ...
  var Tracker = function (template, def, cfg, stg, cpps, display, browser) {
    ...
    this.cpps.onSet.subscribe(fs.proxy(function (key, value) {
      ...
      var nobj = {};
      nobj[key] = value;
      this.stg.set('ckcpps', nobj, 200000, false, utils.persistDataType.TRACKER);
    }, this));
    this.stg.set('ckcpps', this.cpps.all(), 200000, false, utils.persistDataType.TRACKER);
  ...
  Tracker.prototype._sendDefinition = function () {
    ...
    this.stg.set('trackerinfo', jobj, 60000, false, utils.persistDataType.TRACKER);
    /* pragma:DEBUG_START */
