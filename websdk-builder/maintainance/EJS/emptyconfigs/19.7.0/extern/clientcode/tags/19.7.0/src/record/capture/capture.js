...
(function () {
  ...
  var Capture = function (recorder, browser, config, isXDRIFrameMode) {
    ...
    this.recorder.win.onerror = function (msg, url, linenumber) {
      // Log the error
    ...
    if (this.config.advancedSettings && this.config.advancedSettings.scrollEls) {
      ...
      recorder.DomUpdated.subscribe(function (node) {
        // Rebind
  ...
  Capture.prototype._setupMouseTracking = function () {
    ...
    if (!this.browser.isMobile) {
      ...
      utils.Bind(this.recorder.win.document, "record:mousedown", function (e) {
        this.mHandler.call(this.ctx, e, null, this.rec, Logger.EVENT_TYPES.MOUSE_CLICK);
      }.bind({ ctx: this, rec: this.recorder, mHandler: mouseHandler }));
      ...
      if (this.isTop) {
         ...
         */
        utils.Bind(window, "record:deviceorientation", function (event) {
        ...
        this.doOrientationChange = function (event) {
         ...
         */
        utils.Bind(window, "record:touchstart", function () {
    ...
    if (this.isTop) {
      ...
      if (!this.browser.isMobile) {
        ...
        utils.Bind(this.recorder.win.document, "record:mouseout", function (e) {
