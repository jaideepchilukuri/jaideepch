module.exports = {
  ...
  client: {
    ...
    /**
     * Configuration for which journey events we want to send to the analytics
     * (big data) endpoint.
     */
    journeyEvents: {
      /**
      ...
      /**
       * The list of event names. eg. ["fs_pageView", "fs_mouseoff",
       * "fs_inviteShown", "fs_inviteAccepted"]
       */
      list: []
    },

    /**
     * List of CPPs to disable. These will be disabled in trigger, feedback, in
     * the tracker window and in feedback popups.
     *
     * Examples of CPPS url, browser, os, referrer, site, code, GA_ID, OMTR_VID,
     * OMTR_BEACON
     *
