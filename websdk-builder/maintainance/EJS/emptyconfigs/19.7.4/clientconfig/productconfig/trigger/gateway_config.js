({
	...
	/**
	 * Describes whether this module is to be used or not. Can be a function
	 * that returns a boolean or it can just be a boolean.
	 */
	"check" : function() {
		// This next line is where all the properties and survey defs are
		// inserted.
		/**
		 * @preserve
		 * @@CONFIG_GOES_HERE@@
		...
		// If you want to turn things off, then set this to false instead of
		// true
		return true;
	},
