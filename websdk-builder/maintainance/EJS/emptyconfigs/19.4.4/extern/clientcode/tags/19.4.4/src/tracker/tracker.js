...
fs.require("track.Storage.GlobalStorage");
...
(function (tracker) {
  ...
  var Tracker = function (browser, stg, trackerdata) {
    ...
    this.jrny = new utils.Journey(cfg.id, cfg.site_id, stg.get('rid'), browser, 50);
  ...
  Tracker.prototype._loadResources = function (cb) {
    /* pragma:DEBUG_START */
    console.warn("tracker: loading resources");
    /* pragma:DEBUG_END */
    ...
    var cssfilename = fs.makeURI('templates/trigger/' + templateName + '/main.css'),
