...
(function () {
  ...
  Report.prototype.initialize = function () {
    utils.loadCSS(fs.makeURI("$templates/feedback/default/main.css"), function (success, link) {
      if (success) {
        /* pragma:DEBUG_START */
  ...
  Report.prototype.run = function () {
    ...
    if (!this.didBuildUI) {
      ...
      utils.Bind(window, "feedback:message", this.onMessageReceived.bind(this));
  ...
  Report.prototype._addReportBadge = function () {
    if (!this.badge) {
      ...
      this.badge.badgeClicked.subscribe(function () {
        this.showiFrame();
      }.bind(this));
    }
  };
  ...
  Report.prototype._addiFrame = function () {
    ...
    if (!this.didBuildUI) {
      ...
      utils.Bind(this.closeBtn, "feedback:click", function (e) {
        e.preventDefault();
        this.removeReport(e);
        return false;
      }.bind(this));
      ...
      utils.Bind(this.frame, "feedback:load", function (e) {
        var msg = {};
        msg.wIsLoggedIn = "GET";
      ...
      utils.Bind(this.container, "feedback:mouseenter", function (e) {
      ...
      utils.Bind(this.container, "feedback:mouseleave", function (e) {
