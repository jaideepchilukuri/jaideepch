      ...
      new Promise(function (resolve) {
        ...
        var error = function (evt) {
          if (el.tagName === "LINK" && el.getAttribute("rel") === "stylesheet") {
            console.error("FATAL: failed to load stylesheet: " + AssetPreloader.originalUrl(el.getAttribute("href")));
          } else {
            console.warn("Failed to load " + el.tagName + " asset: " + AssetPreloader.originalUrl(el.src || el.href || el.srcset));
          }
          done();
        };
