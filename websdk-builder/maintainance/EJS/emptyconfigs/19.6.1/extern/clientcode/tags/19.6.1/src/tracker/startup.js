      ...
      stg.ready.subscribe(function () {
        ...
        stg.watchForChanges(['trackerinfo', 'trackercmd', 'ckcpps'], function (key, olddata, tcfg) {
          ...
          if (key == 'trackercmd') {
            ...
            if (!fs.isDefined(trackerInst) || trackerInst.data.cfg.active_surveydef.name !== tcfg.cfg.active_surveydef.name) {
            ...
            stg.erase("trackerinfo");

            // When the window loads, fire up the tracker
            if (fs.isDefined(trackerInst)) {
              if (trackerInst.data.cfg.active_surveydef.name !== tcfg.cfg.active_surveydef.name) {
