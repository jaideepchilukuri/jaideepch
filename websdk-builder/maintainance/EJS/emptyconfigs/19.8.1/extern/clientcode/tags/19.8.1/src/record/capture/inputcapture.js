...
InputCapture.prototype._logCaretInfo = function(node, force) {
  ...
  var caretInfo = this._getCaretInfo(node),
    cIl = this._inputCaretInfo.find(function(ci) {
      return ci.ipt === node;
    });
...
InputCapture.prototype._logElScroll = function(node) {
  var cIl = this._inputCaretInfo.find(function(ci) {
    return ci.ipt === node;
  });
...
InputCapture.prototype._stopWatchingInput = function(node) {
  ...
  this._inputValues.splice(
    this._inputValues.find(function(el) {
      return el.ipt === node;
    }),
    1
  );
  this._inputCaretInfo.splice(
    this._inputCaretInfo.find(function(el) {
      return el.ipt === node;
    }),
    1
  );
