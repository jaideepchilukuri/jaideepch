({
  ...
  /**
   * This is in case we want to switch to bubbling mode for specific client urls
   * If you choose to use this make sure the url fits a format that is compatible with the utils.testAgainst function
   */
  useBubbleMode: [],
    ...
    desktop: [
      {
        ...
        dialog: {
          ...
          onexitattribution:
            "ForeSee's <a class='fsrPrivacy' href='//www.foresee.com/privacy-policy.shtml' target='_blank'>Privacy Policy</a>",
          ...
          onexitinvalidFormatErrorText:
            "Format should be: name@domain.com or 123-456-7890",
         ...
         headline: "Je n'est c'est pas!"
          ...
          backdropbg: null, //"rgba(0, 0, 0, 0.7)",
          font: null, //"Lato",
          borderbgcolor: null, //"rgba(0, 0, 0, 0.5)",
          bgcolor: null, //"#ffffff",
          txtcolor: null, //"#000000",
          btntxtcolor: null, //"#000000",
          btnbordercolor: null, //"#ffffff",
          // Left button background color.
          btnbgcolor: null, //"white",
          btnboxshadow: null, //"rgba(0, 0, 0, 0.5)",
          // Right button background color.
          rightbtnbgcolor: null, //"#ffffff",
          leftbtnhoverbg: null, //"#ededed",
          rightbtnhoverbg: null, //"#e8f1e5",

          // Close Button attributes
          closebtncolor: null, //"#595959",
          closebtnbordercolor: null, //"#595959",
          closebtnhoverbgcolor: null //"#cccccc"
        }
      }
    ],
    ...
    mobile: [
      {
        ...
        dialog: {
          ...
          subheadline:
            "Please let us know how to improve our site so we can better serve you.",
          declineButton: "No, thanks",
          ...
          submitButton: "Submit",
          textDisclaimer:
            "Providing your number means you are participating in a ForeSee survey. Message &amp; data rates may apply. 2 messages per survey.",
          emailDisclaimer: "",
          ...
          // Any google font..
          font: null, //"Anton",
          // Uncomment this for mobile invite to scale properly on desktop sites on mobile phones.
  ...
  qualifier: {
    ...
    survey: {
      ...
      /*
       , locales: {
         "fr": {
         topSection: "Je n'est c'est pas!",
         noThanksTopSection: "Je n'est c'est pas!Je n'est c'est pas!.",
         noThanksBottomSection: "Je Je Je Je!.",
         validationFailedMsg: "Je Je Je Je!Je Je Je Je! We.",
  ...
  reminder: {
    ...
    display: {
      ...
      // locales: {
      //    "fr": {
      //    headerSection: "Je n'est c'est pas!",
      //    bodySection: "Je n'est n'est n'est!",
