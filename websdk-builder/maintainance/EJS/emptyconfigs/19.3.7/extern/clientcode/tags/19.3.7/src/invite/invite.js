...
(function () {
  ...
  var Invite = function (config, def, brwsr, fstr, displayoverride, cpps, sngltons) {
    ...
    if (display.dialog.locales && display.dialog.locales[this.locale]) {
      /* pragma:DEBUG_START */
      console.warn("invite: applying locale to invite definition: ", display.dialog.locales[this.locale]);
      /* pragma:DEBUG_END */
      display.dialog = fs.ext(display.dialog, display.dialog.locales[this.locale]);
    }
   ...
   *
   */
  Invite.prototype._trapKeyBoard = function (acsMain, dialog, ff) {
      ...
      utils.HealthStatus(this.brwsr, ["trust"], fs.proxy(function (status) {
        ...
        if (this.isCustom) {
          ...
          var ff = document.getElementById("acsFocusFirst"),
            input = document.getElementById("acsEmailSMSInput"),
          ...
          if (this.brwsr.isMobile) {
            ...
            this._trapKeyBoard(acsMain, dialog, ff);
          }
   ...
   */
  Invite.prototype.returnUserFocus = function () {
