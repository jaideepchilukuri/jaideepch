...
(function (utils) {
  ...
  utils.JSONP.prototype.get = function (src, prefix) {
    ...
    if (!cbQR[gblToken]) {
      ...
      sl.loadFailure.subscribe(function () {
        /* pragma:DEBUG_START */
    ...
    cbQR[gblToken].subscribe(function (res) {
    ...
    }.bind({ ctx: this, tgId: '_fscl' + gblToken }), true, true);

    this._networkError.subscribe(function (type) {
