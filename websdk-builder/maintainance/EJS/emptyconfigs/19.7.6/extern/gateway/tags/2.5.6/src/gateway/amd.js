 ...
 * @type {*}
 */
var global = _W, req, s, head, baseElement, src,
...
function newContext(contextName) {
  ...
  Module.prototype = {
    ...
    callPlugin: function () {
      ...
      on(pluginMap, 'defined', function (plugin) {
        ...
        if (this.map.unnormalized) {
          ...
          if (normalizedMod) {
            ...
            if (this.events.error) {
              normalizedMod.on('error', function (err) {
                this.emit('error', err);
              }.bind(this));
            }
    ...
    enable: function () {
      ...
      each(this.depMaps, function (depMap, i) {
        var id, mod, handler;
        ...
        if (typeof depMap === 'string') {
          ...
          on(depMap, 'defined', function (depExports) {
            this.defineDep(i, depExports);
            this.check();
          }.bind(this));

          if (this.errback) {
            on(depMap, 'error', this.errback.bind(this));
          }
        }
...
req.load = function (context, moduleName, url) {
  ...
  node.setAttribute('data-vendor', 'fs');
