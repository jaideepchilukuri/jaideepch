    ...
    mobile: [
      {
        ...
        style: {
          ...
          presetStyles: "",
          customStyleBlock:
            ".__acs #acsMainInvite .acsCloseButton--container {background: transparent;}" +
            ".__acs #acsMainInvite.acsClassicInvite .__acs--privacy {opacity: 1;background-color: #2f3a4d;}" +
            ".__acs #acsMainInvite.acsClassicInvite {background-color: transparent;}"
        }
      }
    ]
  },
