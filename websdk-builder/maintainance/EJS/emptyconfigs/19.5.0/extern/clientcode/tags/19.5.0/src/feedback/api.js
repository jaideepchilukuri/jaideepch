...
(function () {
  ...
  var _launchFB = function (mid) {
    ...
    if (!cfgIns) {
      ...
      var th = {},
        ajaxReq = function (template, type, prom, cb) {
          var url = _fsNormalizeUrl("templates/feedback/" + template + '/' + type + '.html'),
            jp = new utils.JSONP({
      ...
      var asyncQ = new utils.Async(true, fs.proxy(function () {
        /* pragma: DEBUG_START */
  ...
  var API = {
     ...
     * @param CPPS
     */
    completeAPI: function (cpps, browser) {
