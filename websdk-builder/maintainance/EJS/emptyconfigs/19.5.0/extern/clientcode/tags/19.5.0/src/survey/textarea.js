      ...
      keyupfunc = function (mxln) {
        return function (e) {
          ...
          var targ = e.target || e.srcElement,
            ...
            lblchild = document.getElementById("fsrCharactersRemaining");

          lbl.innerHTML = Math.max(0, remd);
          // If we just append lblchild, it will come after the character count and screw up the CSS
          // Instead we use Insert Adjacent Element
          lbl.insertAdjacentElement("afterbegin", lblchild);
