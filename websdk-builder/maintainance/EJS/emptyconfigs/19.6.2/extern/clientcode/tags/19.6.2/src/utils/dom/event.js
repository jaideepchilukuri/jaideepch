...
(function (utils) {
  ...
  /**
   * Grab the correct keyCode for the 
   */
  utils.getKeyCode = function (e) {
    if (!!e && typeof e.key !== "undefined") {
      return e.key.toLowerCase();
    }
    // We do this as we have to support chrome 30+ and .key was introduced in chrome 50
    var isKeyValid = {
      32: " ",
      13: "enter",
      37: "arrowleft",
    ...
    var keyVal = e.keyCode > 0 ? e.keyCode : e.which;

    return isKeyValid[keyVal];
  };
  ...
  utils.FSEvent.prototype.chain = function (evt, once, stragglers) {
    if (!!evt && evt.constructor === utils.FSEvent) {
      ...
      evt.subscribe(fs.proxy(function () {
        this.fire.apply(this, arguments);
      }, this), once, stragglers);
    }
  };
