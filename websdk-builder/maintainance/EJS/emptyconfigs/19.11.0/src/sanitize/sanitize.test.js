...
/**
 * This is copy-pasta of the bulk of the DOMPurify test cases with most
 * of the SVG/MathML specific tests removed, since this library has been
 * modified to simply remove SVG and MathML markup entirely.
 *
 * These tests are mainly provided for assurance that these sorts of
 * attacks are rendered impossible, and that any modifications to
 * DOMPurify haven't broken its core functionality.
 */
const DOMPurifyTests = [
  {
    title: "Removes SVG entirely",
    payload:
  ...
  },
  {
    ...
    expected:
      '<img src="data:,123"><audio src="data:,456"></audio><video src="data:,789"></video><source src="data:,012"><div></div>',
  },
  {
  ...
  },
  {
    ...
    expected: ['&lt;img onerror="alert(1);//" src=x&gt;', '<img src="x">'],
  },
  {
  ...
  },
  {
    ...
    expected: ["<a>@shafigullin</a><a></a>", "<a>@shafigullin<a></a>"],
  },
  {
  ...
  },
  {
    ...
    expected:
      '<div id="2">&amp;ADz&amp;AGn&amp;AG0&amp;AEf&amp;ACA&amp;AHM&amp;AHI&amp;AGO&amp;AD0&amp;AGn&amp;ACA&amp;AG8Abg&amp;AGUAcgByAG8AcgA9AGEAbABlAHIAdAAoADEAKQ&amp;ACAAPABi//["\'`--&gt;]]&gt;]</div>',
  },
  {
    payload:
      '<div id="3"><meta charset="x-imap4-modified-utf7">&<script&S1&TS&1>alert&A7&(1)&R&UA;&&<&A9&11/script&X&>//["\'`-->]]>]</div>',
    expected:
      '<div id="3">&amp;alert&amp;A7&amp;(1)&amp;R&amp;UA;&amp;&amp;&lt;&amp;A9&amp;11/script&amp;X&amp;&gt;//["\'`--&gt;]]&gt;]</div>',
  },
  {
    payload:
    ...
    expected:
      "<div id=\"4\">0? :postMessage(importScripts('data:;base64,cG9zdE1lc3NhZ2UoJ2FsZXJ0KDEpJyk'))//[\"'`--&gt;]]&gt;]</div>",
  },
  {
    payload:
  ...
  },
  {
    ...
    expected:
      '<div id="12"><br><br><br><br><br><br>...<br><br><br><br><input>//["\'`--&gt;]]&gt;]</div>',
  },
  {
    payload:
  ...
  },
  {
    ...
    expected:
      '<div id="19">\u00BCscript \u00BEalert(19)//\u00BC/script \u00BE//["\'`--&gt;]]&gt;]</div>',
  },
  {
    payload:
  ...
  },
  {
    ...
    expected:
      '<div id="59"><div id="div1"><input value="``onmouseover=alert(59)"></div> <div id="div2"></div>//["\'`--&gt;]]&gt;]</div>',
  },
  {
  ...
  },
  {
    ...
    expected: ['<div id="69">//["\'`--&gt;]]&gt;]</div>', '<div id="69"></div>'],
  },
  {
    payload:
  ...
  },
  {
    ...
    expected:
      '<div id="124"> // Safari 5.0, Chrome 9, 10\n // Safari 5.0//["\'`--&gt;]]&gt;]</div>',
  },
  {
    payload:
  ...
  },
  {
    ...
    expected: ['<img id="foo" name="bar">', '<img name="bar">'],
  },
  {
...
describe("DOMPurify Tests", () => {
  DOMPurifyTests.forEach(test => {
    it(test.title || test.payload, () => {
      const result = sanitize(test.payload);
      if (!test.expected.includes(result)) {
        expect(result).toBe(test.expected[0]);
      }
      expect(test.expected.includes(result)).toBe(true);
    });
  });
  ...
  describe("sanitizeObject", () => {
    it("sanitizes recursively", () => {
      const obj = {
        root: "<a href='javascript:alert(1)'>CLICK</a>",
        number: 1,
        nested: {
          val: "<a href='javascript:alert(1)'>CLICK</a>",
          array: [
            "<a href='javascript:alert(1)'>CLICK</a>",
            "<a href='javascript:alert(1)'>CLICK2</a>",
          ],
        },
      };
