...
var config = {
   ...
   *
   * Example: blacklist: { text: ["*test1.html"], variables: [{ "name":
   * "name1", value: "value1", }, { name: "name2", value: "value2", }],
   * cookies: [{ "name": "cookie3", value: "value3", }], }
   */
  blacklist: {
    text: [],
    variables: [
      {
        name: "foresee_noRecord",
        value: "true"
      }
    ],
    cookies: []
  ...
  /**
   * URL whitelisting, so you can enable record on pages you actually want it
   * to run on.
   */
  whitelist: {
    text: [],
  ...
  advancedSettings: {
    /**
     * Use SessionStorage instead of window.name to store replay data. This
     * will make sure window.name is no longer touched, but it will no
     * longer be able to follow the session between domains as a new
