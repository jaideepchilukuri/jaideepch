...
// Diagnostics for Jenkins jobs
console.log("Current working directory: " + process.cwd());
console.log("Directory used for require: " + __dirname);
...
gulp.task("push_default_config", ["_pullextern"], cb => {
  FCP.pushDefaultConfig(pjson, clientProperties, cb);
});

gulp.task("push_stg", ["sdk"], cb => {
  FCP.pushStg(pjson, clientProperties, cb);
});

gulp.task("push_prod", ["sdk"], cb => {
...
gulp.task("push_products", ["sdk"], cb => {
