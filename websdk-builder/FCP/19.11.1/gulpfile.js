...
const { pjson, clientProperties, getGlobalConfig, isProd, isSSL, testEnvs } = require("./scripts/SDKConfigs.js");
...
gulp.task("self_hosted_debug", ["sdk"], cb => {
  console.error(chalk.red("WARNING: DO NOT GIVE THIS TO A CUSTOMER!!!! use get_self_hosted instead!!!"));
